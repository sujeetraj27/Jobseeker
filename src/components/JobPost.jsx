...
function JobPost() {
  ...
  const [hiringMultipleCandiate, setHiringMultipleCandidates] = useState("");
  ...
  const handlePostJob = (e) => {
    ...
    hiringMultipleCandiate &&
      formData.append("hiringMultipleCandiate", hiringMultipleCandiate);
