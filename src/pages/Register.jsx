...
import { clearAllUserError, register } from '../store/slices/userSlice'
...
function Register() {
  ...
  const [firstNiches, setFirstNiches] = useState("");
  const [secondNiches, setSecondNiches] = useState("");
  const [thirdNiches, setThirdNiches] = useState("");
                ...
                <div className="wrapper">
                  <div className="inputTag">
                    ...
                    <div>
                      <select
                        value={firstNiches}
                        onChange={(e) => setFirstNiches(e.target.value)}
                      >
                  ...
                  <div className="inputTag">
                    ...
                    <div>
                      <select
                        value={secondNiches}
                        onChange={(e) => setSecondNiches(e.target.value)}
                      >
                        <option value="">Your Niche</option>
                        {nichesArray.map((niche, index) => {
                          return (
                  ...
                  <div className="inputTag">
                    ...
                    <div>
                      <select
                        value={thirdNiches}
                        onChange={(e) => setThirdNiches(e.target.value)}
                      >
                        <option value="">Your Niche</option>
                        {nichesArray.map((niche, index) => {
                          return (
